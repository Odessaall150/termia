...
TRANSLATIONS = {
    "es": {
        ...
        "keybindings_conflict": "El atajo {shortcut} ya está asignado a otra acción",
        ...
        "config_file_recovered": "Configuración corrupta recuperada. Se creó copia: {path}",
        "local_terminal_start_failed": "No se pudo iniciar el terminal local: {error}",
        "local_terminal_retry_prompt": "Pulsa Enter para abrir un terminal local nuevo.",
        "local_terminal_closed": "Terminal local cerrado: {title}",
        "ssh_missing": "No se encontró el cliente ssh en el PATH.",
        "ssh_missing_status": "Sin ssh",
        "sshpass_missing": "No se encontró sshpass. Instala sshpass o deja la contraseña vacía.",
        "sshpass_missing_status": "Sin sshpass",
        "ssh_start_failed": "No se pudo iniciar ssh: {error}",
        "ssh_start_failed_toast": "No se pudo iniciar ssh para {name}",
        "ssh_connecting_command": "Conectando: {command}",
        "session_opened": "Sesión abierta: {title}",
        "server_reconnect_missing": "No se encontró el servidor para reconectar",
        "disconnect_session_title": "Desconectar sesión",
        "disconnect_session_detail": "¿Quieres desconectar {title}?",
        "disconnect_session_confirm": "Desconectar",
        "sigterm_failed": "No se pudo enviar SIGTERM al proceso ssh.",
        "session_disconnected_terminal": "Sesión desconectada.",
        "session_disconnected_status": "Desconectada: {title}",
        "session_disconnected_toast": "Sesión desconectada: {title}",
        "session_closed_status": "Cerrada: {title}",
        "session_closed_toast": "Sesión cerrada: {title}",
        "tab_closed_title": "{title} (cerrada)",
        "tab_disconnected_title": "{title} (desconectada)",
        "tab_error_title": "{title} (error)",
        "connection_failed_toast": "Fallo de conexión: {title}",
        "export_config_success": "Configuración exportada",
        "import_config_failed": "No se pudo importar JSON: {error}",
        "import_config_success": "Configuración importada",
        "import_asbru_failed": "No se pudo importar YAML de Ásbrú: {error}",
        "import_asbru_invalid": "El YAML de Ásbrú no tiene un formato compatible",
        "import_asbru_success": "Ásbrú: {groups} grupos y {servers} servidores importados",
    ...
    "ca": {
        ...
        "keybindings_conflict": "La drecera {shortcut} ja està assignada a una altra acció",
        ...
        "config_file_recovered": "Configuració corrupta recuperada. S'ha creat una còpia: {path}",
        "local_terminal_start_failed": "No s'ha pogut iniciar el terminal local: {error}",
        "local_terminal_retry_prompt": "Prem Enter per obrir un terminal local nou.",
        "local_terminal_closed": "Terminal local tancat: {title}",
        "ssh_missing": "No s'ha trobat el client ssh al PATH.",
        "ssh_missing_status": "Sense ssh",
        "sshpass_missing": "No s'ha trobat sshpass. Instal·la sshpass o deixa la contrasenya buida.",
        "sshpass_missing_status": "Sense sshpass",
        "ssh_start_failed": "No s'ha pogut iniciar ssh: {error}",
        "ssh_start_failed_toast": "No s'ha pogut iniciar ssh per a {name}",
        "ssh_connecting_command": "Connectant: {command}",
        "session_opened": "Sessió oberta: {title}",
        "server_reconnect_missing": "No s'ha trobat el servidor per reconnectar",
        "disconnect_session_title": "Desconnectar sessió",
        "disconnect_session_detail": "Vols desconnectar {title}?",
        "disconnect_session_confirm": "Desconnectar",
        "sigterm_failed": "No s'ha pogut enviar SIGTERM al procés ssh.",
        "session_disconnected_terminal": "Sessió desconnectada.",
        "session_disconnected_status": "Desconnectada: {title}",
        "session_disconnected_toast": "Sessió desconnectada: {title}",
        "session_closed_status": "Tancada: {title}",
        "session_closed_toast": "Sessió tancada: {title}",
        "tab_closed_title": "{title} (tancada)",
        "tab_disconnected_title": "{title} (desconnectada)",
        "tab_error_title": "{title} (error)",
        "connection_failed_toast": "Error de connexió: {title}",
        "export_config_success": "Configuració exportada",
        "import_config_failed": "No s'ha pogut importar JSON: {error}",
        "import_config_success": "Configuració importada",
        "import_asbru_failed": "No s'ha pogut importar YAML d'Ásbrú: {error}",
        "import_asbru_invalid": "El YAML d'Ásbrú no té un format compatible",
        "import_asbru_success": "Ásbrú: {groups} grups i {servers} servidors importats",
