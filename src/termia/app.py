...
class TermiaWindow(ConfigActionsMixin, ConnectionDialogsMixin, MainMenuMixin, PreferencesMixin, SidebarMixin, StatisticsViewMixin, TabsMixin, Gtk.ApplicationWindow):
