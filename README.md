...
```bash
python3 -m py_compile run_termia.py src/termia/app.py src/termia/asbru_import.py src/termia/config_io.py src/termia/connection_utils.py src/termia/constants.py src/termia/i18n.py src/termia/models.py src/termia/statistics_utils.py src/termia/statistics_view.py src/termia/stores.py src/termia/styles.py src/termia/terminal_config.py src/termia/ui_state.py
